...
namespace cn.com.farsight.WX.WXDbVisit
{
    public class CommandManager
    {
        ...
        public bool getModel(string TableName,NodeCommand model)
        {
        ...
        public bool addModel(string TableName,NodeCommand model)
        {
            DateTime dt = new DateTime();
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ");
            strSql.Append(TableName);
            strSql.Append("(identify,type,addr,modle,data,userid,time) values (@identify,@type,@addr,@modle,@data,@userid,@time)");
        ...
        public bool deleteModel(string TableName,NodeCommand model)
        {
        ...
        public List<NodeCommand> getModelList(string TableName,NodeCommand model)
        {
		...
		/// </summary>
		/// <returns></returns>
        public List<NodeCommand> getModelListTop(string TableName,NodeCommand model, int top)
        {
            List<NodeCommand> ModelList = new List<NodeCommand>();
            StringBuilder sql = new StringBuilder();
            sql.Append("select ");
        ...
        /// 获取记录总数
        /// </summary>
        public int GetRecordCount(string TableName,NodeCommand model)
        {
            StringBuilder sql = new StringBuilder();
        ...
        /// 分页获取数据列表
        /// </summary>
        public NodeCommand GetListByPage(string TableName,NodeCommand model)
        {
            StringBuilder sql = new StringBuilder();
            List<NodeCommand> ModelList = new List<NodeCommand>();
            sql.Append("SELECT * FROM ( ");
